 ...
 * @author nikol
 */
public class GetActiveGames extends AbstractGenericOperation{
    ...
    protected void executeOperation(Object param) throws Exception {
        ...
        ArrayList<Game> list = (ArrayList<Game>) repository.getAllJoinCondition(new Game(), new Team(), new Game().getActiveCondition());
